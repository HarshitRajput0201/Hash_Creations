...
const PortfolioCard = ({imageURL, cardName, cardDescription, cardLink}) => {
  return (
    <div className="flex flex-col w-full justify-between items-center gap-5 p-5 rounded-3xl border border-border bg-cardBg " style={{ aspectRatio: '14/10' }}>
      ...
      <div className="w-full flex flex-row justify-between">
        <div className="flex flex-col gap-2">
            ...
            <p className="text-lg font-bodyfont text-textDescription 2xl:text-xl">{cardDescription}</p>
        </div>
