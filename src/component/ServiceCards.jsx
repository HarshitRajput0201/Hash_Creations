...
const ServiceCards = () => {
  return (
    <div className="w-10/12 grid grid-cols-3 gap-5 2xl:max-w-[1440px] 2xl:gap-8 xxs:grid-cols-1 xxs:w-11/12 xxs:mx-4 xxs:gap-4">
        {
            ServiceCardsData.map((cardData, index) => (
                <div className="w-full flex justify-center items-center rounded-2xl relative overflow-hidden shadow-default " key={index}>
                    ...
                    <div className="w-full h-full flex flex-col justify-between gap-6 rounded-2xl p-7 border border-border bg-cardBg 2xl:gap-10 2xl:p-8 lg:p-5 xxs:p-4">
