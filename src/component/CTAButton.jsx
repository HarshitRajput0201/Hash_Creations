  ...
  return (
    <div className='w-full flex justify-center items-center lg:text-sm xl:text-lg xl:h-12'>
      <Link className='h-full w-full' to={linkto}>
          <div className='h-full w-full flex justify-center items-center bg-navBtnBg text-white px-6 py-3 rounded-lg lg:px-4 lg:py-2 xl:px-6 xl:py-2 xxxs:py-2 sm:py-2'>{children}</div>
      </Link>
    </div>
  )
}
