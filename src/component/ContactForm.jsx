...
const ContactForm = () => {
  return (
    <div className="w-full flex flex-row justify-between items-center bg-cardBg rounded-3xl border border-border shadow-default overflow-hidden p-10 xxxs:flex-col xxxs:py-2 xxxs:px-0 xxxs:bg-transparent xxxs:border-none xxxs:gap-6 xxxs:shadow-none sm:p-5">
      ...
      <form className="w-[50%] h-full flex flex-col gap-5 bg-card p-6 rounded-2xl border border-border xxxs:w-full xxxs:bg-none xxxs:p-4 xxs:p-5 sm:w-[60%] sm:p-5">
        <div className="flex flex-col gap-2 xxxs:gap-1 sm:gap-1">
          <label htmlFor="name" className="text-lg xxxs:text-[16px] sm:text-base">
            Name
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-2 xxs:gap-1 sm:gap-1">
          <label
            htmlFor="email"
            className="text-lg xxs:text-[16px] sm:text-base"
          >
            Email
          </label>
          <input
