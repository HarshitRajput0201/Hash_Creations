...
const NavBar = () => {
  return (
    <div className='w-10/12 mx-auto 2xl:flex flex-row justify-between absolute top-10'>
      ...
      <div className="2xl:flex flex-row justify-around items-center border border-border rounded-xl text-lg gap-1 p-2 bg-nav-bg">
