  ...
  return (
    <div className="flex flex-col items-center w-full font-headingfont bg-background text-heading relative overflow-hidden">
      <div className="flex flex-col items-center w-full relative z-10">
        ...
        <div className="w-full flex justify-center items-center my-32 overflow-x-hidden 2xl:my-36">
          <ImgSlider/>
        </div>
        <div className="w-full flex flex-col justify-between items-center my-24 gap-20 2xl:my-28 2xl:gap-24">
