  ...
  return (
    <div className="flex flex-col items-center w-full font-headingfont bg-background text-textHeading relative transition-all duration-200">
      <div className="flex flex-col items-center w-full relative z-10" >
        ...
        <img className="absolute w-full h-[300px] top-[500px] z-0 lg:top-[380px] xl:top-[440px] xxs:top-[580px] xxs:h-[170px] xs:top-[680px] object-cover" src={HeroBG2} alt="HeroBG2" />
        ...
        <NavBar/>
        <div className="flex flex-col w-10/12 mt-36 z-10 2xl:max-w-[1440px] 2xl:mt-40 lg:mt-32 xl:mt-36 xxs:w-11/12 xxs:mx-4 xxs:mt-24 xs:mt-28 xs:w-10/12">
          <div className="w-full flex flex-col justify-between items-center gap-16 2xl:gap-20 lg:gap-12 xl:gap-16 xxs:items-start xs:gap-20">
            <div className="w-9/12 flex flex-col items-center gap-6 2xl:gap-8 lg:gap-5 xl:gap-6 xxs:w-full xxs:gap-4 xs:gap-5">
              <h1 className="text-[64px] leading-tight text-textHeading text-center capitalize font-semibold 2xl:text-[68px] xl:text-[56px] lg:text-[48px] xxs:text-[32px] xxs:text-start xs:text-[38px]">Transforming Business with Cutting-Edge Solution</h1>
              <p className="w-6/12 text-lg text-textDescription text-center 2xl:text-xl lg:w-8/12 xl:w-7/12 xxs:text-start xxs:w-full xxs:text-[16px] xs:text-[20px]">We Create Custom Software, Mobile Apps, and Seamless UI/UX Designs</p>
            </div>
            <div className="flex justify-center items-start">
              <CTAButton linkto="/">
                <div className="flex justify-between items-center gap-2 text-lg 2xl:text-xl lg:text-[16px] xxs:text-[16px] xs:text-lg">
        ...
        <div className="w-full flex justify-center items-center mt-32 mb-24 overflow-x-hidden 2xl:mt-36 lg:mt-20 lg:mb-16 xxs:mt-20 xxs:mb-16 xs:mt-24 xs:mb-20">
          <ImgSlider/>
        </div>
        <div className="w-full flex flex-col justify-between items-center pt-40 gap-20 mb-24 2xl:gap-24 lg:gap-16 lg:pt-28 xxs:pt-32 xxs:gap-16 xxs:mb-16 xs:mb-20 xs:pt-36" id="services">
        ...
        <div className="w-full flex justify-center items-center mt-24 mb-4 2xl:mt-28 xxs:flex-col-reverse xxs:gap-16 xxs:mt-16 xs:mt-20">
          <div className="w-10/12 flex flex-row justify-between items-center gap-10 2xl:max-w-[1440px] lg:gap-8 xxs:w-11/12 xxs:mx-4 xxs:flex-col-reverse xxs:gap-6 xs:gap-7 xs:w-10/12">
            <div className="w-[50%] h-full flex flex-col justify-between items-center gap-12 2xl:gap-14 lg:gap-8 xxs:w-full">
              ...
              <div className="w-full grid grid-cols-2 gap-4 2xl:gap-5 xxs:gap-4 xs:gap-5">
                <div className="flex flex-row justify-between items-center gap-4 p-4 bg-cardBg rounded-2xl border border-border 2xl:gap-5 lg:p-3 lg:gap-3 xxs:flex-col xxs:items-start xxs:gap-4 xs:p-5">
                  <div className="flex justify-center items-center p-3 bg-workIconBg rounded-lg text-workIconText lg:p-2 xxs:p-2"><FaPeopleGroup className="w-6 h-6 2xl:w-7 2xl:h-7 lg:w-5 lg:h-5 xxs:h-4 xxs:w-4 xs:h-6 xs:w-6" /></div>
                  <div className="flex flex-wrap lg:text-[12px] xxs:text-sm xs:text-base">Responsive and Mobile-First Design</div>
                </div>
                <div className="flex flex-row justify-between items-center gap-4 p-4 bg-cardBg rounded-2xl border border-border 2xl:gap-5 lg:p-3 lg:gap-3 xxs:flex-col xxs:items-start xxs:gap-4 xs:p-5">
                  <div className="flex justify-center items-center p-3 bg-workIconBg rounded-lg text-workIconText lg:p-2  xxs:p-2"><FaPeopleGroup className="w-6 h-6 2xl:w-7 2xl:h-7 lg:w-5 lg:h-5 xxs:h-4 xxs:w-4 xs:h-6 xs:w-6" /></div>
                  <div className="flex flex-wrap lg:text-[12px] xxs:text-sm xs:text-base">Responsive and Mobile-First Design</div>
        ...
        <div className="w-full flex flex-col justify-between items-center gap-20 mb-24 pt-40 2xl:gap-24 lg:gap-16 lg:pt-28 xxs:pt-32 xxs:gap-16 xxs:mb-16 xs:mb-20 xs:pt-36" id="work">
          ...
          <div className="w-10/12 grid grid-cols-2 gap-5 2xl:gap-8 2xl:max-w-[1440px] xxs:grid-cols-1 xxs:w-11/12 xxs:mx-4 xs:w-10/12">
            {
        ...
        <div className="w-full flex justify-center items-center my-24 2xl:my-28 xxs:flex-col xxs:gap-16 xxs:my-16 xs:my-20">
          <HeadingBlock badgeheading={"OUR SERVICES"} mainheading={"Explore Our Core"} mainspan={"Services"} description={"Delivering web, app, and design solutions that empower your brand and captivate your audience."}/>
          <div className="w-10/12 flex flex-row justify-between items-center gap-10 2xl:max-w-[1440px] lg:gap-8 xxs:flex-col xxs:w-11/12 xxs:mx-4 xxs:gap-6 xs:w-10/12">
            <div className="w-[50%] h-full flex justify-center items-center rounded-3xl overflow-hidden xxs:w-full xxs:rounded-2xl">
              <img className="w-full h-full object-cover" src={WorkImage} alt="" />
            </div>
            <div className="w-[50%] h-full flex flex-col justify-between items-center gap-12 2xl:gap-14 lg:gap-8 xxs:w-full">
        ...
        <div className="w-full flex flex-col justify-between items-center gap-20 my-24 2xl:my-28 2xl:gap-24 xxs:my-16 xs:my-20">
          <HeadingBlock badgeheading={"OUR WORK"} mainheading={"Explore Our "} mainspan={"Portfolio"} description={"Delivering web, app, and design solutions that empower your brand and captivate your audience."} />
          <div className="TestimonialsDiv w-10/12 h-[600px] flex flex-row justify-between items-center gap-5 overflow-hidden 2xl:max-w-[1440px] lg:max-w-[900px] xxs:w-11/12 xxs:mx-4 xxs:flex-col xxs:h-fit xxs:gap-4 xs:w-10/12">
        ...
        <div className="w-full flex flex-col justify-between items-center gap-20 my-24 xxs:my-16 xxs:gap-16 xs:my-20">
          <HeadingBlock badgeheading={"CONTACT US"} mainheading={"Let’s Work Together"} />
          <div className="w-10/12 flex flex-col justify-between items-center gap-5 2xl:max-w-[1440px] xxs:w-11/12 xxs:mx-4 xxs:gap-9 xs:w-10/12">
            <ContactCards />
            <ContactForm />
